...
#define __PYX_HAVE_API__pointer2ndarray
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
...
/* Module declarations from 'pointer2ndarray' */
__PYX_EXTERN_C DL_EXPORT(PyObject) *tonumpyarray(double *, PY_LONG_LONG); /*proto*/
#define __Pyx_MODULE_NAME "pointer2ndarray"
int __pyx_module_is_main_pointer2ndarray = 0;

/* Implementation of 'pointer2ndarray' */
...
PyObject *tonumpyarray(double *__pyx_v_data, PY_LONG_LONG __pyx_v_size) {
 ...
 */
  ...
  /* "pointer2ndarray.pyx":8
 *     cdef np.npy_intp dims = size
 *     #NOTE: it doesn't take ownership of `data`. You must free `data` yourself
 *     return np.PyArray_SimpleNewFromData(1, &dims, np.NPY_DOUBLE, <void*>data)             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_3 = PyArray_SimpleNewFromData(1, (&__pyx_v_dims), NPY_DOUBLE, ((void *)__pyx_v_data)); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 8; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  __Pyx_AddTraceback("pointer2ndarray.tonumpyarray", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
static int __Pyx_InitCachedBuiltins(void) {
  __pyx_builtin_ValueError = __Pyx_GetBuiltinName(__pyx_n_s_ValueError); if (!__pyx_builtin_ValueError) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 5; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initpointer2ndarray(void); /*proto*/
PyMODINIT_FUNC initpointer2ndarray(void)
#else
PyMODINIT_FUNC PyInit_pointer2ndarray(void); /*proto*/
...
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_pointer2ndarray(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("pointer2ndarray", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_pointer2ndarray) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (!PyDict_GetItemString(modules, "pointer2ndarray")) {
      if (unlikely(PyDict_SetItemString(modules, "pointer2ndarray", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  if (__Pyx_ExportFunction("tonumpyarray", (void (*)(void))tonumpyarray, "PyObject *(double *, PY_LONG_LONG)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  /*--- Type init code ---*/
  /*--- Type import code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pointer2ndarray", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pointer2ndarray");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
